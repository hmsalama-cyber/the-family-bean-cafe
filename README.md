...
Website for **The Family Bean Cafe**.
...
## Deployment
This is a static website and can be deployed on Cloudflare Pages. After deployment, replace the placeholder domain in `robots.txt` and `sitemap.xml`.
